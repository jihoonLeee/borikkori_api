...
import borikkori.community.api.adapter.in.web.post.request.CommentReactionRequest;
...
public class CommentController {
	...
	@PostMapping("/like")
	public ResponseEntity<CommentResponse> reactionComment(@AuthenticationPrincipal CustomUserDetails customUser,
		@RequestBody CommentReactionRequest req) {
		CommentResponse res = commentUsecase.reactionComment(
			req.getCommentId(),
