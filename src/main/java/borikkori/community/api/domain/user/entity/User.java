...
public class User {
    ...
    public User(UserId id, String name, String email, String password,
                boolean active, boolean emailVerified, boolean accountLocked,
                int failedLoginAttempts, LocalDateTime lastLoginDate,
                LocalDateTime regDate, LocalDateTime updDate,List<Role> roles,MbtiType mbtiResult) {
    ...
    public static User create(String name, String email, String encodedPassword) {
        ...
        return new User(null, name, email, encodedPassword,
                true, false, false,
                0, null, now, now, defaultRoles,null);
    }
